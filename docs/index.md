...
### Disclaimer
I'm not an Epidemiologist or scientist. I have only applied a modified version of a solution created by [Bettencourt & Ribeiro 2008](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0002185) to estimate real-time ![$R_t$](https://render.githubusercontent.com/render/math?math=%24R_t%24) using a Bayesian approach. While this paper estimates a static $R$ value, here we introduce a process model with Gaussian noise to estimate a time-varying ![$R_t$](https://render.githubusercontent.com/render/math?math=%24R_t%24).
